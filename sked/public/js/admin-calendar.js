...
$('#date-picker').datepick({
    onSelect: function (dates) {
        dateCont++;
        if (dateCont == 1) {
            $('#dates-input').append('<div class="row visible-md visible-lg">' + '<div class="col-sm-12" style="height: 20px"></div>' + '<div class="col-sm-2"></div>' + '<div class="col-sm-4">' + '<p class="text header-text">Days</p>' + '</div>' + '<div class="col-sm-4">' + '<p class="text header-text">Time</p>' + '</div>' + '</div>');
        }
